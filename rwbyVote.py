...
def bestChars(win):
    ...
    #this sets the code to funtion up to 100 clicks
    for mouse in range(100):
        ...
        if weissClick.p1.x < mouse.x < weissClick.p2.x and weissClick.p1.y < mouse.y < weissClick.p2.y:
        ...
        if blakeClick.p1.x < mouse.x < blakeClick.p2.x and blakeClick.p1.y < mouse.y < blakeClick.p2.y:
        ...
        if yangClick.p1.x < mouse.x < yangClick.p2.x and yangClick.p1.y < mouse.y < yangClick.p2.y:
        ...
        if jauneClick.p1.x < mouse.x < jauneClick.p2.x and jauneClick.p1.y < mouse.y < jauneClick.p2.y:
        ...
        if noraClick.p1.x < mouse.x < noraClick.p2.x and noraClick.p1.y < mouse.y < noraClick.p2.y:
        ...
        if pyrrhaClick.p1.x < mouse.x < pyrrhaClick.p2.x and pyrrhaClick.p1.y < mouse.y < pyrrhaClick.p2.y:
        ...
        if renClick.p1.x < mouse.x < renClick.p2.x and renClick.p1.y < mouse.y < renClick.p2.y:
